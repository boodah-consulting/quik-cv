...
import JobsComponent from '@/components/TechnicalPeer/Jobs.vue'
import ProjectsComponent from '@/components/TechnicalPeer/Projects.vue'
import SkillsComponent from '@/components/TechnicalPeer/Skills.vue'
 ...
 *   <TechnicalPeerPage />
 *
 * @module TechnicalPeerPage
 *
 */
export default {
  name: 'TechnicalPeerPage',
  props: {
    cv: {
      type: Object,
      required: true
