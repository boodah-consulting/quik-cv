...
import JobsComponent from '@/components/HiringManager/Jobs.vue'
import ProjectsComponent from '@/components/HiringManager/Projects.vue'
import SkillsComponent from '@/components/HiringManager/Skills.vue'
